...
def main():
    ...
    # Scrape button
    if st.button("Scrap It!", disabled=st.session_state.button_disabled):
        ...
        # Force a rerun to update the UI (disable the button)
        st.rerun()

    # Start processing only if the button was clicked and is now disabled
